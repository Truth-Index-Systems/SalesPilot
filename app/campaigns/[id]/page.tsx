...
export default async function CampaignDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const stageLabel = discoveryRunning ? (({PREPARING:"Preparing company discovery",SEARCHING:"Searching for matching companies",ANALYSING:"Analysing company fit",VALIDATING:"Validating evidence",SAVING:"Saving recommendations",COMPLETE:"Companies ready for review"} as Record<string,string>)[discovery?.stage] ?? "Researching matching companies") : discoveryPreparingFirstPass ? "Preparing company discovery" : discoveryExpansionPending ? "Expanding company search" : discoveryExhausted ? "Extended search completed" : jobStateLabel(discovery, { queued: "Company discovery queued", complete: "Companies ready for review", noResults: "No new supported companies found" });
