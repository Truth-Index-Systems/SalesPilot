...
export default async function CampaignDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const stageLabel = discoveryRunning ? (({PREPARING:"Preparing company discovery",PLANNING:"Building the market search plan",SEARCH_PLAN_RUNNING:"Building your market search strategy",SEARCH_PLAN_READY:"Search strategy ready",BREADTH_DISCOVERY:"Searching your market",DISCOVERY_BATCH_READY:"Companies discovered · checking evidence",SEARCHING:"Searching for matching companies",VERIFYING:"Verifying official evidence",SAVING:"Saving recommendations",READY:"Companies ready for review",COMPLETE:"Companies ready for review"} as Record<string,string>)[discovery?.stage] ?? "Researching matching companies") : discoveryPreparingFirstPass ? "Preparing company discovery" : discoveryExpansionPending ? "Expanding company search" : discoveryPreparationRetry ? "Preparing company discovery" : discoveryExhausted ? "Extended search completed" : jobStateLabel(discovery, { queued: "Company research scheduled", complete: "Companies ready for review", noResults: "No new supported companies found" });
