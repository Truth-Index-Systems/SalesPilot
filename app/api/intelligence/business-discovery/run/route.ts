...
export async function POST(request:Request){
 ...
 catch(error){console.error("Business analysis worker failed",error);return NextResponse.json({ok:false,error:{code:"WORKER_FAILED",title:"Analysis could not continue",message:"SalesPilot could not continue this analysis job.",hint:"The saved job can be retried safely."}},{status:500});}
}
