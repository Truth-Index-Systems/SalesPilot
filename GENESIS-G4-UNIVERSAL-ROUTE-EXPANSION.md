...
- Pass 3: departmental routes, procurement, regional leadership and executive assistants
- Pass 4: final official-source verification

Technical failures remain on the existing retry/dead-letter path. Valid but insufficient route research uses the neutral EXPANDING state. No verification threshold is weakened.
