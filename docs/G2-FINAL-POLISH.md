# Genesis G2 Final Polish

This patch freezes the customer-facing Company Discovery experience before G3.
...
- Corrected `ExternalLink` icon export and formatted discovery OpenAI schema.
