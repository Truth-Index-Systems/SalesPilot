...
const DEFAULT_TIMEOUT_MS: Record<AiRequestTask, number> = {
  ...
  GENESIS_G8_REPAIR: 120_000,
  GENESIS_G82_EXPANSION: 120_000,
  GENESIS_G82_DEPTH: 120_000,
};
...
const ENV_KEYS: Record<AiRequestTask, string> = {
  ...
  GENESIS_G8_REPAIR: "MARKETROUTE_AI_TIMEOUT_G8_REPAIR_MS",
  GENESIS_G82_EXPANSION: "MARKETROUTE_AI_TIMEOUT_G82_EXPANSION_MS",
  GENESIS_G82_DEPTH: "MARKETROUTE_AI_TIMEOUT_G82_DEPTH_MS",
};
