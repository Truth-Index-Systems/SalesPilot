...
export const G5SelfReviewSchema = z.object({
  ...
  promptVersion: z.enum(["g5-self-review/v1", "g5-self-review/v2-chief-revenue-risk"]),
...
export const g5SelfReviewJsonSchema = {
  ...
  properties: {
    schemaVersion:{type:"string",enum:["g5-self-review/v1"]}, promptVersion:{type:"string",enum:["g5-self-review/v2-chief-revenue-risk"]},
