export type EngagementReviewOverview = {
  ...
  channel_type: string; opportunity_score: number | null; buying_reason: string | null; operational_pain: string | null; recommended_action: string | null;
  ...
  buyer_priorities_json: string[]; likely_objections_json: string[]; recommended_tone: string | null; cta_strategy: string | null; commercial_reasoning: string | null;
};
