...
export const G5ChannelStrategySchema = z.object({
  ...
  promptVersion: z.enum(["g5-channel-strategy/v1", "g5-channel-strategy/v2-vp-sales-development", "g5-channel-strategy/v3-responsibility-boundary", "cie-r5-route-authority/v1", "cie-r5-route-authority/v2", "cie-r5-route-authority/v3"]),
...
export const g5ChannelStrategyJsonSchema = {
  ...
  properties: {
    ...
    promptVersion: { type: "string", enum: ["g5-channel-strategy/v3-responsibility-boundary", "cie-r5-route-authority/v1", "cie-r5-route-authority/v2", "cie-r5-route-authority/v3"] },
