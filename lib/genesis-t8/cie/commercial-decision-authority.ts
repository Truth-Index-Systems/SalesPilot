...
export function evaluateCieR4CommercialDecision(input: CieR4CommercialDecisionInput): CieR4CommercialDecision {
  ...
  return Object.freeze({
    ...
    deterministicReasons: Object.freeze([
      ...
      "R4_COMMERCIAL_AUTHORITY_IS_DISTINCT_FROM_R5_ROUTE_AND_R6_CONTACT_AUTHORITY",
      "R5_AND_R6_MUST_SEPARATELY_AUTHORISE_EXECUTION",
...
export const CIE_R4_LAWS = Object.freeze([
  ...
  "R4_CANNOT_UNLOCK_ENGAGEMENT_WITHOUT_CURRENT_R5_ROUTE_AND_R6_CONTACT_AUTHORITY",
