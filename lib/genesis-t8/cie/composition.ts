...
export const CIE_AUTHORITY_MIGRATION_MAP = Object.freeze([
  ...
  { id: "ROUTE_WEIGHTED_AUTHORITY", source: "lib/contacts/deterministic-authority.ts", decision: "route ranking", currentOwner: "LEGACY", targetOwner: "UDOSIB", currentMode: "AUTHORITATIVE", targetRelease: "CIE-R5" },
  { id: "G5_AI_ROUTE_SELECTION", source: "lib/engagement/g5-channel-strategy-openai.ts", decision: "primary/secondary/fallback route selection", currentOwner: "AI", targetOwner: "UDOSIB", currentMode: "AUTHORITATIVE", targetRelease: "CIE-R5" },
