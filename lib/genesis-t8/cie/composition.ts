...
export type CieAuthorityMode = "AUTHORITATIVE" | "SHADOW" | "PRESENTATION_ONLY" | "ERADICATED" | "LEGACY_TO_ERADICATE";
...
export const CIE_AUTHORITY_MIGRATION_MAP = Object.freeze([
  { id: "LIVE_OPPORTUNITY_SCORING", source: "lib/opportunities/scoring.ts", decision: "opportunity scoring", currentOwner: "LEGACY", targetOwner: "UDOSIB", currentMode: "ERADICATED", targetRelease: "CIE-R4" },
  ...
  { id: "CONTACT_WEIGHTED_AUTHORITY", source: "lib/contacts/deterministic-authority.ts", decision: "contact ranking", currentOwner: "LEGACY", targetOwner: "UDOSIB", currentMode: "ERADICATED", targetRelease: "CIE-R6" },
  { id: "CONTACT_CONFIDENCE_TELEMETRY", source: "lib/contacts/deterministic-authority.ts", decision: "contact evidence confidence presentation", currentOwner: "LEGACY", targetOwner: "MARKETROUTE", currentMode: "PRESENTATION_ONLY", targetRelease: "CIE-R8" },
  { id: "ROUTE_WEIGHTED_AUTHORITY", source: "lib/contacts/deterministic-authority.ts", decision: "route ranking", currentOwner: "LEGACY", targetOwner: "UDOSIB", currentMode: "ERADICATED", targetRelease: "CIE-R5" },
  ...
  { id: "G5_AI_ROUTE_SELECTION", source: "lib/engagement/g5-channel-strategy-openai.ts", decision: "primary/secondary/fallback route selection", currentOwner: "AI", targetOwner: "UDOSIB", currentMode: "ERADICATED", targetRelease: "CIE-R5" },
