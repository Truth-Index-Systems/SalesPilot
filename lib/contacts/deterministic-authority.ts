...
export function deterministicRouteOrderingScore(_input: {
  ...
  throw new Error("CIE_R8_AUTHORITY_VIOLATION:LEGACY_WEIGHTED_ROUTE_RANKING_ERADICATED");
}

/**
 * Compatibility telemetry finalisation. Contact confidence and channel routing
 * values may be retained for evidence presentation, but array order is canonical
 * and no weighted value may control CIE contact/route authority.
 */
