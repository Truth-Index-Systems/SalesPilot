...
begin
  ...
  if coalesce(p_schema_version,'')<>'g5-commercial-reasoning/v1'
     or coalesce(p_prompt_version,'')<>'g5-commercial-reasoning/v3-responsibility-boundary' then
...
begin
  ...
  if coalesce(p_schema_version,'')<>'g5-channel-strategy/v1'
     or coalesce(p_prompt_version,'')<>'g5-channel-strategy/v3-responsibility-boundary' then
...
begin
  ...
  if coalesce(p_schema_version,'')<>'g5-outreach-generation/v1'
     or coalesce(p_prompt_version,'')<>'g5-outreach-generation/v5-responsibility-boundary' then
