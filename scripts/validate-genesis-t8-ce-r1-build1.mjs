...
check("constitution is explicitly versioned", /GENESIS_T8_CONSTITUTION_VERSION\s*=\s*"1\.0\.0"/.test(constitution));
...
check("Truth Engine contract exists", /TRUTH:\s*Object\.freeze/.test(constitution));
check("Commercial Engine contract exists", /COMMERCIAL:\s*Object\.freeze/.test(constitution));
check("Contact Engine contract exists", /CONTACT:\s*Object\.freeze/.test(constitution));
check("Route Engine contract exists", /ROUTE:\s*Object\.freeze/.test(constitution));
check("Opportunity Engine contract exists", /OPPORTUNITY:\s*Object\.freeze/.test(constitution));
