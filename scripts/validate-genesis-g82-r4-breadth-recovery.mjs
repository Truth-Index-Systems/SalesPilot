...
const checks=[
 ['R4 recovery capability retained',ai.includes('BREADTH')||ai.includes('breadth-recovery')],
 ['three-company reliable batch retained',ai.includes('GENESIS_G82_EXPANSION_COMPANIES_PER_CALL = 3')],
