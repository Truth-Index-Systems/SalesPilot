...
const checks=[
 ['R19/R20 activation lineage',activation.includes('G8.1-R20-ADAPTIVE-DEFAULT-1.0')],
 ['levels 0 through 5 preserved',activation.includes('0:{mode:"OFF"')&&activation.includes('5:{mode:"ADAPTIVE_DEFAULT"')],
 ...
 ['runtime fails closed',activation.includes('configured_level:0')&&activation.includes('FAIL_CLOSED')],
 ...
 ['production merge remains fail open',merge.includes('failed open to Discovery')&&merge.includes('fallbackUsed:true')],
 ...
 ['founder dashboard controls activation',dashboard.includes('Genesis operating model')&&dashboard.includes('/dashboard/genesis-g8/activation')],
