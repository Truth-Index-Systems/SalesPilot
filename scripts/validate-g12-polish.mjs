...
const required = ["Your outbound sales campaign is ready", "Company Discovery", "Why SalesPilot recommended this strategy", "Campaign timeline", "campaign-roadmap", "workspaceStats"];
