-- Genesis G8.2 production reconciliation: restore missing depth queue + RPCs
-- Idempotent by design. Safe to apply even if 0136 was already installed.
-- Required after production returned PGRST202 for depth RPCs.
...
-- Force PostgREST to refresh its function/schema cache immediately after migration.
